...
public class RegistrarMovimentacaoFuncionalidade {
    ...
    @Entao("uma movimentacao do tipo ENTRADA deve ser criada")
    ...
    @Dado("o pedido esta associado ao estoque {string}")
    ...
    @Entao("a movimentacao deve conter o motivo {string}")
    ...
    @Entao("deve exibir a mensagem de movimentacao {string}")
    ...
    @Entao("cada movimentacao deve conter data, tipo, quantidade e responsavel")
