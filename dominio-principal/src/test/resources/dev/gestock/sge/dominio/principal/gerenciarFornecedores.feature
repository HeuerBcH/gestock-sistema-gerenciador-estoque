...
Cenário: Cadastrar fornecedor com lead time específico
  ...
  Cenário: Registrar cotação para um produto
    ...
    Quando o cliente registra uma cotação de "150.00" reais com prazo de "10" dias para o produto "01"
    Então a cotação deve ser registrada com sucesso
    E o fornecedor deve ter cotação para o produto "01"
  ...
  Cenário: Tentar registrar cotação com prazo inválido
    ...
    Quando o cliente tenta registrar uma cotação para o produto "Produto X" com prazo -5 dias
  ...
  Cenário: Tentar registrar cotação com preço inválido
    Dado que existe um fornecedor chamado "Fornecedor A"
    E existe um produto chamado "Produto X" com id "01"
    Quando o cliente tenta registrar uma cotação para o produto "Produto X" com preço 0 reais
    Então o sistema deve rejeitar a operação
  ...
  Cenário: Remover cotação de um produto
    Dado que existe um fornecedor chamado "Fornecedor A"
    E o fornecedor possui cotação para o produto "01"
    Quando o cliente remove a cotação do produto "01"
