...
Funcionalidade: Gerenciar Fornecedores
  ...
  # H5: Cadastrar fornecedores com lead time, contato e cotacoes
  ...
  # R2H5: Lead time informado deve ser positivo
  ...
  # H6: Atualizar informacoes de fornecedores
  ...
  # R1H6: Alterar lead time recalcula ROP dos produtos associados
  Cenario: Recalibrar lead time com base no historico de entregas
    ...
    E o ponto de ressuprimento dos produtos associados deve ser recalculado
  ...
  # R1H7: Fornecedor nao pode ser inativado se houver pedidos pendentes
