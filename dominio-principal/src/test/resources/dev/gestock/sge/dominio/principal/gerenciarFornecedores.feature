...
Funcionalidade: Gerenciar Fornecedores
  ...
  Cenário: Cadastrar fornecedor com sucesso
    Dado que não existe um fornecedor cadastrado com o CNPJ "12.345.678/0001-90"
...
Cenário: Cadastrar fornecedor com lead time específico
  Dado que não existe um fornecedor cadastrado com o CNPJ "98.765.432/0001-10"
  ...
  Cenário: Tentar registrar cotação com prazo inválido
    ...
    E existe um produto chamado "Produto X" com id "prod-001"
    Quando eu tento registrar uma cotação para o produto "Produto X" com prazo -5 dias
  ...
  Cenário: Tentar registrar cotação com preço inválido
    Dado que existe um fornecedor chamado "Fornecedor A"
    E existe um produto chamado "Produto X" com id "prod-001"
    Quando eu tento registrar uma cotação para o produto "Produto X" com preço 0 reais
    Então o sistema deve rejeitar a operação
  ...
  Cenário: Atualizar dados cadastrais do fornecedor
    ...
    Quando eu atualizo os dados do fornecedor para nome "Fornecedor A Atualizado" e contato "novo@email.com"
  ...
  Cenário: Recalibrar lead time com base no histórico de entregas
    ...
    E o fornecedor possui histórico de entregas de 8, 9, 7, 10 e 8 dias
    Quando eu recalibro o lead time com base no histórico de entregas
    Então o lead time do fornecedor deve ser atualizado para 8 dias

  Cenário: Tentar recalibrar lead time sem histórico de entregas
    Dado que existe um fornecedor chamado "Fornecedor A" sem histórico de entregas
    Quando eu tento recalibrar o lead time
    Então o sistema deve rejeitar a operação
  ...
  Cenário: Remover cotação de um produto
    Dado que existe um fornecedor chamado "Fornecedor A"
    E o fornecedor possui cotação para o produto "prod-001"
    Quando eu removo a cotação do produto "prod-001"
    Então a cotação deve ser removida
    E o fornecedor não deve possuir cotação para o produto "prod-001"
