...
Funcionalidade: Transferir Produtos entre Estoques
  ...
  Cenario: Tentar transferir sem saldo suficiente
    ...
    E deve exibir a mensagem de transferencia "Saldo disponivel insuficiente"
  ...
  Cenario: Verificar movimentacoes da transferencia
    ...
    E o sistema deve exibir uma movimentacao de entrada no Estoque Destino
  ...
  Cenario: Visualizar historico de transferencias
    ...
    E cada registro deve conter data, produto, quantidade, estoque origem e estoque destino
  ...
  Cenario: Tentar cancelar transferencia concluida
    ...
    Entao o sistema deve rejeitar a operacao de transferencia
    E deve exibir a mensagem de transferencia "Transferencia concluida nao pode ser cancelada"